"""
UE Features SubSection Agent

UE_Features 섹션에서 Item 추출
"""

from typing import Any

from .base import BaseSubSectionAgent
from ...prompts.subsection_prompts import UE_FEATURES_PROMPT
from ...utils.llm_client import call_llm_for_items


class UEFeaturesSubAgent(BaseSubSectionAgent):
    """UE Features SubSection Agent

    명세서 5.2.4 참조:
    - 단위: Feature 그룹 / Work Item
    - 주요 결과: Agreement
    - FG 정보 보존 (text에 포함)
    """
    ...
    def extract_items(
        ...
        items = call_llm_for_items(
            ...
            prompt_template=UE_FEATURES_PROMPT,
        )
